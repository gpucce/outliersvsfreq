...
def main():
    ...
    for idxs in idxs_groups:
        ...
        generated = pd.read_csv(generation_out_dir / f"{model_name}_{idxs_name}_tok_counts.csv")
        ...
        generated = generated.loc[
            :,
            (~generated.columns.str.contains("real") & ~generated.columns.str.contains("hid")),
        ]
        ...
        toks_err_df = pd.DataFrame({"tokens": toks, "gen_toks": gentoks, "freq_change": errors})
        ...
        toks_err_df.to_csv(generation_out_dir / f"{model_name}_{idxs}_all_tokens_in_a_row.csv")
